...
import saveSession, { Params } from "../saveSession";
...
const saveSessionSuccess = new LoginWithGoogleModel({
...
async function setup() {
  return saveSession(defaultParams, datasourcesMocks);
}
...
const mocks = {
  ...
  success: {
    saveSession: saveSessionSuccess,
  },
};
